...
export class IncomePage {
    ...
    showItems(result) {
        ...
        for (let i = 0; i < result.response.length; i++) {
            ...
            cardActionElement.innerHTML = '<a href="/edit-income?id=' + result.response[i].id + '&title=' + result.response[i].title + '" class="btn btn-primary me-2 mb-2" type="button">Редактировать</a>' +
